...
from .pfilter import ParticleFilter, rectangle
...
class Track:
    ...
    def __init__(self, mean, covariance, track_id, n_init, max_age,
                 feature=None, frame_shape=(540, 960, 3), bbox_tlwh=None, cur_img=None):
        self.mean = mean
    ...
    def update(self, kf, detection, cur_img):
    ...
    def pf_update(self, cur_rect, cur_img):
        # print("\n",cur_rect)
        self.pf.update(cur_rect=cur_rect, im=cur_img)
        self.pf.resample()
